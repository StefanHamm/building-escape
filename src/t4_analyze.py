...
K_VALS = [0.5, 1, 3, 5]
XI_VALS = [0.1, 0.5, 0.9]
METRIC_IDX = 1  # 0: Steps, 1: Collisions, 2: Blocked


def plot_efficiency_grid(file_path):
    # Load data: (Floors, Agents, K, Xi, Metrics)
...
def plot_floor_vs_agents(file_path, k_val, xi_val):
    """
...
if __name__ == "__main__":
    ...
    plot_efficiency_grid(path)
    plot_floor_vs_agents(path, k_val=5, xi_val=0.5)
